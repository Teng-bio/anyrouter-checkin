...
3. 当前主配置基线：
   - 全量运行：`config/batch1.json`
   - LinuxDo 授权：`config/linuxdo_prepare.json`
   - runanytime 单站调试：`config/runanytime_linuxdo.json`
4. 当前已验证结论（2026-02-25）：
   - 有效账号 8 个全成功
   - AnyRouter 2 个账号 + LinuxDo 6 个站点均正常
